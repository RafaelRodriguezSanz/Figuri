...
import ucu.edu.uy.Persistencia.ORM.PotgresORM;
...
public class UserService {
    ...
    public boolean createUser(String nombreParam, String apellidoParam, String contraseniaParam, String direccionParam,
            String fotoParam, String telefonoParam, String ciParam) throws IOException, SQLException {
        ...
        Foto foto = new Foto(fotoParam);
        Telefono telefono = new Telefono(telefonoParam);
        CI ci = new CI(ciParam);
        UserDTO user = new UserDTO(nombre, contrasenia, direccion, foto, telefono, ci);
        return UserDAO.createUser(PotgresORM.getInstance().toPO(user));
    }
}
